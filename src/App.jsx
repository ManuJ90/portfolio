    ...
    return (
        <>
            <div className="fixed bottom-2 lg:top-2 lg:bottom-auto right-3 z-10 flex flex-col md:flex-row gap-3 ">
                <button className="rounded-full bg-black p-1 transition duration-1000 dark:border-white dark:bg-white text-sm text-white dark:text-black group h-12 w-12 flex items-center justify-center" aria-label="CV download button">
                    <a href="https://shorturl.at/bCSUX" target="_blank" className="flex flex-col justify-center" aria-label="Link to my Curriculum Vitae">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-8 h-8 group-hover:hidden">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75l3 3m0 0l3-3m-3 3v-7.5M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                        <p className="px-1 text-sm text-center hidden group-hover:block">CV</p>
                    </a>
                </button>
                <button
                    type='button'
