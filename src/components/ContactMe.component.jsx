            ...
            <SectionTitle>Contact Me</SectionTitle>
            {
                ...
                <div className="m-auto w-10/12 p-10">
                    <div className='relative m-auto mt-8 w-fit text-center'>
                        <div
                            className="absolute -inset-0.5 bg-gradient-to-r from-neon via-spring to-neon2 opacity-70 rounded-lg filter blur-xl animate-pulse"/>
                        <div
                            className='relative w-full rounded-lg border border-gray-100 bg-black/10 px-7 py-2 font-bold uppercase text-black backdrop-blur-3xl font-nunito dark:border-gray-700 dark:text-white'>
                            Message sent
                        </div>
                    </div>
						...
						<div>
							...
							<div className="flex justify-end">
								<div className='relative mt-8 w-fit group'>
									<div
                                        className="absolute -inset-0.5 bg-gradient-to-r from-bittersweet via-tangelo to-persimmon opacity-70 rounded-lg blur-sm group-active:blur-md transition duration-1000 group-active:duration-200 group-active:-inset-1 animate-tilt">
									</div>
									<button
                                        type='submit'
